...
class cloudyIon:
    ...
    _el = [
        ...
        },
        {
            ...
            "mass": 20.180,
            "isotopes": [20, 21, 22],
            "ionEnergy": [21.5645, 40.962, 63.45, 97.11, 126.21, 157.93, 207.27, 239.09, 1195.797, 1362.164],
        },
        {
            "number": 11,
            "name": "Sodium",
            ...
            "mass": 22.990,
            "isotopes": [23],
            "ionEnergy": [5.1391, 47.286, 71.64, 98.91, 138.39, 172.15, 208.47, 264.18, 299.87, 1465.091, 1648.659],
        },
        {
            "number": 12,
            "name": "Magnesium",
        ...
        if solarAbunds:
            ...
            if sP.snapHasField("gas", "GFM_Metals"):
                if self._elementNameToSymbol(element) in sP.metals:
                    ...
                    print(
                        "WARNING: GFM_Metals available but does not contain [%s]. Assuming solar abundances." % element
                    )
                    metal_mass_fraction = (metal / self._solar_Z) * self._solarMetalAbundanceMassRatio(element)
            else:
                print(
                    "WARNING: Snap abundances requested but GFM_Metals not available (mini-snap). Assuming solar abundances."
                )
                metal_mass_fraction = (metal / self._solar_Z) * self._solarMetalAbundanceMassRatio(element)
