"""
Mock LEGA-C slit spectra (Po-Feng Wu+ 2021).
https://arxiv.org/abs/2108.10455
"""
from functools import partial

import matplotlib.pyplot as plt

from ...catalog.subhalos import subhaloStellarPhot
from ...load.auxcat import fieldComputeFunctionMapping as ac
from ...plot.config import colors, linestyles
from ...util import simParams

# add auxcats
ac['Subhalo_LEGA-C_SlitSpectra_NoVel_NoEm_p07c_cf00dust_res_conv_z'] = \
  partial(subhaloStellarPhot, rad='legac_slit', iso='padova07', imf='chabrier', dust='cf00_res_conv',
  fullSubhaloSpectra=1, Nside='z-axis', redshifted=True, minStellarMass=9.8)

ac['Subhalo_LEGA-C_SlitSpectra_NoVel_NoEm_p07c_cf00dust_res_conv_z_restframe'] = \
  partial(subhaloStellarPhot, rad='legac_slit', iso='padova07', imf='chabrier', dust='cf00_res_conv',
                                         fullSubhaloSpectra=1, Nside='z-axis', minStellarMass=9.8)

ac['Subhalo_LEGA-C_SlitSpectra_NoVel_NoEm_Seeing_p07c_cf00dust_res_conv_z'] = \
  partial(subhaloStellarPhot, rad='legac_slit', iso='padova07', imf='chabrier', dust='cf00_res_conv',
  fullSubhaloSpectra=1, Nside='z-axis', redshifted=True, seeing=0.4, minStellarMass=9.8)
ac['Subhalo_LEGA-C_SlitSpectra_NoVel_NoEm_Seeing_p07s_cf00dust_res_conv_z'] = \
  partial(subhaloStellarPhot, rad='legac_slit', iso='padova07', imf='salpeter', dust='cf00_res_conv',
  fullSubhaloSpectra=1, Nside='z-axis', redshifted=True, seeing=0.4, minStellarMass=9.8)

ac['Subhalo_LEGA-C_SlitSpectra_NoVel_Em_p07c_cf00dust_res_conv_z'] = \
  partial(subhaloStellarPhot, rad='legac_slit', iso='padova07', imf='chabrier', dust='cf00_res_conv',
  fullSubhaloSpectra=1, Nside='z-axis', redshifted=True, emlines=True, minStellarMass=9.8)
ac['Subhalo_LEGA-C_SlitSpectra_NoVel_Em_Seeing_p07c_cf00dust_res_conv_z'] = \
  partial(subhaloStellarPhot, rad='legac_slit', iso='padova07', imf='chabrier', dust='cf00_res_conv',
...
def plot_spectra():
    ...
    for i, subInd in subInds:
        for j, acField in enumerate(acFields):
            ...
            ax.plot(ac['wavelength'], data[acField][subInd,:], color=colors[i], ls=linestyles[j], 
                    marker='o', markersize=1.5, label=label)
