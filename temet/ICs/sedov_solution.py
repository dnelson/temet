""" Idealized ICs: analytical solution of the 3D Sedov blast wave, given the ICs, at some time t.
...
def sedov(t, E0, rho0, g=5/3, n=1000, nu=3):
    ...
    Args:
      ...
      n - number of points to compute solution on
      nu - dimensionality
      g - polytropic gas gamma
    """
