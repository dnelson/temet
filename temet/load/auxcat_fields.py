...
def_fields = {
    ...
    # masses and volumes (ISM phases)
    "Subhalo_Mass_r015rvir_Gas_Total": partial(
        subhaloRadialReduction, ptType="gas", ptProperty="mass", op="sum", rad="r015vir_galaxy"
    ),
    "Subhalo_Vol_r015rvir_Gas_Total": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
        rad="r015vir_galaxy",
        ptRestrictions={"temp": ["ge", 0]},
    ),
    "Subhalo_Mass_r015rvir_Gas_Hot": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="mass",
        op="sum",
        rad="r015vir_galaxy",
        ptRestrictions={"temp": ["ge", 5e4]},
    ),
    "Subhalo_Vol_r015rvir_Gas_Hot": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
    ...
    "Subhalo_Mass_r015rvir_Gas_Warm": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="mass",
        op="sum",
        rad="r015vir_galaxy",
        ptRestrictions={"temp": ["between", [5e3, 5e4]]},
    ),
    "Subhalo_Vol_r015rvir_Gas_Warm": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
    ...
    "Subhalo_Mass_r015rvir_Gas_Warm_Ionized": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="mass",
        op="sum",
        rad="r015vir_galaxy",
        ptRestrictions={"temp": ["between", [5e3, 5e4]], "xhi": ["ge", 1e-2]},
    ),
    "Subhalo_Mass_r015rvir_Gas_Warm_Neutral": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="mass",
        op="sum",
        rad="r015vir_galaxy",
        ptRestrictions={"temp": ["between", [5e3, 5e4]], "xhi": ["lt", 1e-2]},
    ),
    "Subhalo_Vol_r015rvir_Gas_Warm_Ionized": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
    ...
    "Subhalo_Vol_r015rvir_Gas_Warm_Neutral": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
    ...
    "Subhalo_Mass_r015rvir_Gas_Cool": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="mass",
        op="sum",
        rad="r015vir_galaxy",
        ptRestrictions={"temp": ["between", [100, 5e3]]},
    ),
    "Subhalo_Vol_r015rvir_Gas_Cool": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
    ...
    "Subhalo_Mass_r015rvir_Gas_Cold": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="mass",
        op="sum",
    ...
    "Subhalo_Vol_r015rvir_Gas_Cold": partial(
        subhaloRadialReduction,
        ptType="gas",
        ptProperty="vol",
        op="sum",
    ...
    "Subhalo_StellarMassFormed_FoF_10myr": partial(
        subhaloRadialReduction,
        ptType="stars",
        ptProperty="initialmass",
        op="sum",
    ...
    "Subhalo_StellarMassFormed_FoF_100myr": partial(
        subhaloRadialReduction,
        ptType="stars",
        ptProperty="initialmass",
        op="sum",
