...
def clumpTracerTracks(sP, haloID, clumpID, sbNum=None):
    ...
    time_xlim = [-500,300] if sbNum is not None else [-3000, 100]
    ...
    # load
    data = clumpTracerTracksLoad(sP, haloID, clumpID, sbNum)
